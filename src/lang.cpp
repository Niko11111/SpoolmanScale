...
const char* const STRINGS[][3] = {
  ...
  // Navigation
  { "Abbrechen",        "Cancel",       "Cancel" },  // STR_CANCEL
  { "Zurück",           "Back",         "Back" },  // STR_BACK
  { "Bestätigen",       "Confirm",      "Confirm" },  // STR_CONFIRM
  { "Erneut versuchen", "Try again",    "Try again" },  // STR_RETRY
  { "ID neu eingeben",  "Enter new ID", "Enter new ID" },  // STR_ENTER_NEW_ID

  // Mainscreen Labels
  { "Spoolman",         "Spoolman",    "Spoolman" },  // STR_LBL_SPOOLMAN
  { "Waage",            "Scale",       "Scale" },  // STR_LBL_SCALE
  { "Letzte Benutzung", "Last used",   "Last used" },  // STR_LBL_LAST_USED
  { "Letzte Trocknung", "Last dried",  "Last dried" },  // STR_LBL_LAST_DRIED
  { "Temperatur",       "Temperature", "Temperature" },  // STR_LBL_TEMP
  { "Hersteller",       "Vendor",      "Vendor" },  // STR_LBL_VENDOR

  // Mainscreen Status
  { "Spule an Reader halten...",    "Hold spool near reader...",    "Hold spool near reader..." },  // STR_WAIT_SCAN
  { "NFC Tag erkannt",              "NFC tag detected",             "NFC tag detected" },  // STR_TAG_FOUND
  { "Kein WLAN",                    "No WiFi",                      "No WiFi" },  // STR_NO_WIFI
  { "Warte...",                     "Please wait...",               "Please wait..." },  // STR_WAIT
  { "Warte auf Scan...",            "Waiting for scan...",          "Waiting for scan..." },  // STR_WAIT_SCAN_SM
  { "unbekannt",                    "unknown",                      "unknown" },  // STR_UNKNOWN
  { "nicht lesbar",                 "not readable",                 "not readable" },  // STR_NOT_READABLE
  { "heute",                        "today",                        "today" },  // STR_TODAY
  { "gestern",                      "yesterday",                    "yesterday" },  // STR_YESTERDAY
  { "vor %d Tagen",                 "%d days ago",                  "%d days ago" },  // STR_DAYS_AGO
  { "Fehler beim Speichern",        "Error saving",                 "Error saving" },  // STR_ERR_SAVE
  { "Nicht in Spoolman",            "Not in Spoolman",              "Not in Spoolman" },  // STR_NOT_IN_SPOOLMAN
  { "Archiviert",                   "Archived",                     "Archived" },  // STR_ARCHIVED
  { "Lese Tag...",                  "Reading tag...",               "Reading tag..." },  // STR_READING_TAG
  { "Durchsuche Inventar...", "Searching inventory...",
    "Searching inventory..." },  // STR_SEARCHING_INVENTORY
  { "Durchsuche Inventar... %u KB", "Searching inventory... %u KB",
    "Searching inventory... %u KB" },  // STR_SEARCHING_INVENTORY_KB

  // Mainscreen Buttons
  { "Gewicht updaten",  "Update Weight", "Update Weight" },  // STR_BTN_WEIGHT
  { "Heute getrocknet", "Dried today",   "Dried today" },  // STR_BTN_DRIED
  { "Spule verknüpfen", "Link Spool",    "Link Spool" },  // STR_BTN_LINK

  // Welcome Screen

  // WiFi Setup
  { "WLAN einrichten",          "WiFi setup",           "WiFi setup" },  // STR_WIFI_TITLE
  { "Netzwerke suchen...",      "Scanning networks...", "Scanning networks..." },  // STR_WIFI_SCAN
  { "Keine Netzwerke gefunden", "No networks found",    "No networks found" },  // STR_WIFI_NO_NET
  { "WLAN-Passwort",            "WiFi password",        "WiFi password" },  // STR_WIFI_PASS_TITLE
  { "Passwort für: %s",         "Password for: %s",     "Password for: %s" },  // STR_WIFI_PASS_HINT
  { "Passwort...",              "Password...",          "Password..." },  // STR_WIFI_PASS_PLACEHOLDER
  { "Verbinde mit %s...",       "Connecting to %s...",  "Connecting to %s..." },  // STR_WIFI_CONNECTING
  { "Verbunden!",               "Connected!",           "Connected!" },  // STR_WIFI_SUCCESS

  // Spoolman IP
  { "Spoolman Server", "Spoolman Server", "Spoolman Server" },  // STR_SPOOLMAN_TITLE

  // Settings
  { "Einstellungen",               "Settings",                 "Settings" },  // STR_SETTINGS_TITLE
  { "Verbindung",                  "Connection",               "Connection" },  // STR_TILE_CONNECTION
  { "WLAN & Server",               "WiFi & server",            "WiFi & server" },  // STR_TILE_CONN_SUB
  { "Waage",                       "Scale",                    "Scale" },  // STR_TILE_SCALE
  { "Kalibrieren | Beutel | Mehr", "Calibrate | Bag | More",   "Calibrate | Bag | More" },  // STR_TILE_SCALE_SUB
  { "Display",                     "Display",                  "Display" },  // STR_TILE_DISPLAY
  { "Helligkeit & Timeout",        "Brightness & Timeout",     "Brightness & Timeout" },  // STR_TILE_DISPLAY_SUB
  { "System",                      "System",                   "System" },  // STR_TILE_SYSTEM
  { "Sprache | Update | Info",     "Language | Update | Info", "Language | Update | Info" },  // STR_TILE_SYSTEM_SUB

  // Connection
  { "WLAN-Einstellungen", "WiFi settings",     "WiFi settings" },  // STR_BTN_WIFI_SETTINGS
  { "Nicht konfiguriert", "Not configured",    "Not configured" },  // STR_BTN_WIFI_NONE
  { "WLAN-Status",        "WiFi status",       "WiFi status" },  // STR_BTN_WIFI_STATUS
  { "Nicht verbunden",    "Not connected",     "Not connected" },  // STR_BTN_WIFI_STATUS_SUB
  { "Server, OTA, Logs",  "Server, OTA, logs", "Server, OTA, logs" },  // STR_BTN_WEB_SUB
  { "Webserver",          "Web server",        "Web server" },  // STR_WEB_SERVER
  { "Wartung",            "Maintenance",       "Maintenance" },  // STR_WEB_MAINT
  { "Einstellungen",      "Settings",          "Settings" },  // STR_WEB_CONFIG
  ...
  // Scale
  { "Waage",         "Scale",       "Scale" },  // STR_SCALE_TITLE
  { "Kalibrierung",  "Calibration", "Calibration" },  // STR_BTN_CALIBRATE
  { "Beutelgewicht", "Bag weight",  "Bag weight" },  // STR_BTN_BAGWEIGHT

  // Calibration
  { "Kalibrierung",             "Calibration",              "Calibration" },  // STR_CAL_TITLE
  { "Faktor: --",               "Factor: --",               "Factor: --" },  // STR_CAL_FACTOR
  { "Faktor: %.4f",             "Factor: %.4f",             "Factor: %.4f" },  // STR_CAL_OK
  { "Fehler: Gewicht = 0",      "Error: weight = 0",        "Error: weight = 0" },  // STR_CAL_ZERO_ERR
  { LV_SYMBOL_OK "  Berechnen", LV_SYMBOL_OK "  Calculate", LV_SYMBOL_OK "  Calculate" },  // STR_BTN_CALCULATE
  ...
  { "%.1fg gespeichert", "%.1fg saved",   "%.1fg saved" },  // STR_BAG_SAVED
  { "Ungültiger Wert",   "Invalid value", "Invalid value" },  // STR_BAG_INVALID

  // Display
  { "Display", "Display", "Display" },  // STR_DISPLAY_TITLE
  ...
  // System
  { "System",                                "System",                                "System" },  // STR_SYSTEM_TITLE
  { "Deutsch / English", "Deutsch / English",
    "Deutsch / English" },  // STR_BTN_LANG_SUB
  { "Firmware Update", "Firmware Update",
    "Firmware Update" },  // STR_BTN_FW_UPDATE
  { "Browser oder GitHub", "Browser or GitHub",
    "Browser or GitHub" },  // STR_BTN_FW_SUB
  { "Info & Unterstützung", "Info & Support",
    "Info & Support" },  // STR_BTN_INFO
  { "Ko-fi - GitHub - Discord - MakerWorld", "Ko-fi - GitHub - Discord - MakerWorld",
    "Ko-fi - GitHub - Discord - MakerWorld" },  // STR_BTN_INFO_SUB

  // Language screen
  { "Sprache / Language", "Sprache / Language", "Sprache / Language" },  // STR_LANG_TITLE
  { "Gerät startet nach Auswahl neu.",
    "Device will reboot after selection.",
    "Device will reboot after selection." },  // STR_LANG_HINT
  { "Datum / Date format:", "Datum / Date format:", "Datum / Date format:" },  // STR_DATE_FMT_LABEL

  // OTA
  { "Firmware Update",                   "Firmware Update",                    "Firmware Update" },  // STR_OTA_TITLE
  { "Upload via Webbrowser", "Upload via web browser",
    "Upload via web browser" },  // STR_OTA_BROWSER
  { ".bin vom PC + SD-Logging", "Upload from PC + SD logging",
    "Upload from PC + SD logging" },  // STR_OTA_BROWSER_SUB
  { "Update via GitHub", "Update via GitHub",
    "Update via GitHub" },  // STR_OTA_GITHUB
  { "Direkt-Update aus GitHub Releases", "Direct update from GitHub Releases",
    "Direct update from GitHub Releases" },  // STR_OTA_GITHUB_SUB
  { "Browser Update", "Browser Update",
    "Browser Update" },  // STR_OTA_BROWSER_TITLE
  ...
  { "Aktuell: %s", "Current: %s", "Current: %s" },  // STR_OTA_CURRENT
  ...
  // Link Flow
  { "Bambu-Spule verknüpfen", "Link Bambu spool",  "Link Bambu spool" },  // STR_LINK_BAMBU_TITLE
  { "Unbekannte Spule",       "Unknown spool",     "Unknown spool" },  // STR_LINK_NTAG_TITLE
  { "Spool-ID eingeben",      "Enter Spool-ID",    "Enter Spool-ID" },  // STR_BTN_ENTER_ID
  { "Aus Liste wählen",       "Choose from list",  "Choose from list" },  // STR_BTN_FROM_LIST
  { "Spoolman Spool-ID",      "Spoolman Spool-ID", "Spoolman Spool-ID" },  // STR_LINK_ID_TITLE
  { "Prüfe...",               "Checking...",       "Checking..." },  // STR_LINK_CHECKING
  { "ID nicht gefunden",      "ID not found",      "ID not found" },  // STR_LINK_ID_NOT_FOUND
  { "HTTP Fehler %d",         "HTTP Error %d",     "HTTP Error %d" },  // STR_LINK_HTTP_ERR
  { "JSON Fehler",            "JSON error",        "JSON error" },  // STR_LINK_JSON_ERR
  { "Kein WLAN",              "No WiFi",           "No WiFi" },  // STR_LINK_NO_WIFI
  ...
  { "Material stimmt nicht überein", "Material mismatch", "Material mismatch" },  // STR_WARN_B_TITLE
  ...
  { "Hersteller wählen  (%d Spulen)", "Choose vendor  (%d spools)",
    "Choose vendor  (%d spools)" },  // STR_VENDOR_TITLE
  { "Material wählen",                "Choose material",            "Choose material" },  // STR_MAT_TITLE
  { "Keine Spulen ohne Tag\nin Spoolman gefunden.",
    "No unlinked spools\nfound in Spoolman.",
    "No unlinked spools\nfound in Spoolman." },  // STR_NO_VENDORS
  { "Keine Materialien gefunden.", "No materials found.",
    "No materials found." },  // STR_NO_MATERIALS
  ...
  { "Verknüpfen?", "Link this spool?",
    "Link this spool?" },  // STR_CONFIRM_LINK
  { LV_SYMBOL_OK "  Verknüpfen", LV_SYMBOL_OK "  Link",
    LV_SYMBOL_OK "  Link" },  // STR_LINK_OK

  // Tare
  { LV_SYMBOL_OK "  Tare gesetzt!", LV_SYMBOL_OK "  Tare set!", LV_SYMBOL_OK "  Tare set!" },  // STR_TARE_OK
  ...
  { "API Fehler", "API Error", "API Error" },  // STR_API_ERROR

  // Reboot popup
  { "Neustart erforderlich", "Restart required", "Restart required" },  // STR_REBOOT_TITLE
  ...
  { "Gut",           "Good",         "Good" },  // STR_WIFI_QUAL_GOOD
  { "Mittel",        "Medium",       "Medium" },  // STR_WIFI_QUAL_MEDIUM
  { "Schwach",       "Weak",         "Weak" },  // STR_WIFI_QUAL_WEAK
  { "Verbunden",     "Connected",    "Connected" },  // STR_WIFI_STATUS_CONNECTED
  { "Getrennt",      "Disconnected", "Disconnected" },  // STR_WIFI_STATUS_DISCONNECTED

  // Numpad buttons
  { LV_SYMBOL_OK "  Speichern", LV_SYMBOL_OK "  Save", LV_SYMBOL_OK "  Save" },  // STR_BTN_SAVE

  // Spool list title
  { "Alle", "All", "All" },  // STR_SPOOLS_ALL

  // Settings calibration sub
  { "Faktor: %.2f", "Factor: %.2f", "Factor: %.2f" },  // STR_CAL_FACTOR_SHORT
  ...
  { "Sprache und Zeitzone", "Language and time zone", "Language and time zone" },  // STR_WELCOME_LANG_TITLE
  ...
  // WiFi scan count
  { "%d Netzwerke gefunden", "%d networks found", "%d networks found" },  // STR_WIFI_NETWORKS_FOUND

  // Bag weight current label
  { "Aktuell: %.0f g", "Current: %.0f g", "Current: %.0f g" },  // STR_BAG_CURRENT
  ...
  // Link entry context
  { "%s | nicht in Spoolman", "%s | not in Spoolman", "%s | not in Spoolman" },  // STR_LINK_CTX_NOT_IN_SM
  ...
  { "Wird die Nutzung deines Filaments in Spoolman genau getrackt, z.B. automatisch durch OpenSpoolMan beim Bambu Lab Drucker, dann wird auf dem Hauptscreen das Datum der letzten Benutzung aus Spoolman angezeigt.",
    ...
    "If your filament usage is tracked in Spoolman, e.g. automatically via OpenSpoolMan with a Bambu Lab printer, the main screen will show the date of the last use from Spoolman." },  // STR_LASTUSED_DESC_OSM
  { "Wird das 'Last Used' Feld in Spoolman nicht aktiv von dir genutzt, dann benutzt SpoolmanScale dieses Feld, um das Datum des letzten Gewichtsupdates zu speichern. Der Hauptscreen zeigt dann 'Zuletzt gewogen' statt 'Zuletzt benutzt'.",
    ...
    "If you don't actively use the 'Last Used' field in Spoolman, SpoolmanScale will use it to store the date of the last weight update. The main screen will then show 'Last Weighed' instead of 'Last Used'." },  // STR_LASTUSED_DESC_WEIGHED
  ...
  { "FilaMan pflegt 'Zuletzt benutzt' selbst und trägt dort echten Druckverbrauch ein, z.B. über seine Druckeranbindung. Solange noch kein Druck erfasst wurde, zeigt der Hauptscreen ersatzweise die letzte Wägung an.",
    ...
    "FilaMan maintains 'Last Used' itself and records real print consumption there, e.g. through its printer integration. Until a print has been recorded, the main screen falls back to the last weighing." },  // STR_LASTUSED_DESC_FILAMAN_USED
  { "FilaMan protokolliert jede Wägung mit Zeitstempel, auch die von dieser Waage. Der Hauptscreen zeigt dann 'Zuletzt gewogen' und damit, wann du die Spule zuletzt in der Hand hattest. Es wird nichts zusätzlich gespeichert.",
    ...
    "FilaMan logs every weighing with a timestamp, including the ones from this scale. The main screen then shows 'Last Weighed', i.e. when you last handled the spool. Nothing extra is stored." },  // STR_LASTUSED_DESC_FILAMAN_WEIGHED
  ...
  { "BamBuddy trägt 'Zuletzt benutzt' selbst ein, wenn ein Druck von dieser Spule verbraucht. Solange kein Druck erfasst wurde, zeigt der Hauptscreen ersatzweise die letzte Wägung an.",
    ...
    "BamBuddy fills 'last used' itself when a print consumes this spool. Until a print has been recorded, the main screen falls back to the last weighing." },  // STR_LASTUSED_DESC_BAMBUDDY_USED
  { "BamBuddy stempelt jede Wägung mit Zeitstempel, auch die von dieser Waage. Der Hauptscreen zeigt dann 'Zuletzt gewogen'. Nur das BamBuddy-Inventar führt dieses Feld - mit einem Spoolman-Server dahinter bleibt es leer.",
    ...
    "BamBuddy stamps every weighing, including the ones from this scale. The main screen then shows 'last weighed'. Only the BamBuddy inventory keeps this field - with a Spoolman server behind it, it stays empty." },  // STR_LASTUSED_DESC_BAMBUDDY_WEIGHED
  { "Druckverbrauch oder Wägung",
    "Print usage or weighing",
  ...
  { "Gemessen: %.0f g. Das Etikett sagt %.0f g. BamBuddy kann nicht mehr speichern, als das Etikett hergibt - der Rest stünde danach wieder auf voll.",
    ...
    "Measured: %.0f g. The label says %.0f g. BamBuddy cannot store more than the label allows, so the remainder would read as full again." },  // STR_BB_CAP_BODY
  ...
  { "BamBuddy hat kein Feld für ein Trocknungsdatum. Das Notizfeld geht immer und behält den übrigen Text. Der andere Weg schreibt in last_dried auf dem Spoolman-Server hinter BamBuddy.",
    ...
    "BamBuddy has no field for a drying date. The note field always works and keeps the rest of the text. The other route writes into last_dried on the Spoolman server behind BamBuddy." },  // STR_BB_DRIED_INFO
  ...
  { "Werkseinstellungen",         "Factory Reset",      "Factory Reset" },  // STR_BTN_FACTORY_RESET
  { "Alle Einstellungen löschen", "Erase all settings", "Erase all settings" },  // STR_BTN_FACTORY_RESET_SUB
  { "Werkseinstellungen?",        "Factory Reset?",     "Factory Reset?" },  // STR_FACTORY_RESET_TITLE
  ...
  { "Ja, alles löschen", "Yes, erase everything",
    "Yes, erase everything" },  // STR_FACTORY_RESET_CONFIRM
  { "Spule kopieren", "Copy spool",
    "Copy spool" },  // STR_BTN_COPY_SPOOL
  { "Spule kopieren", "Copy spool",
    "Copy spool" },  // STR_COPY_TITLE
  { "Spoolman-ID eingeben", "Enter Spoolman ID",
    "Enter Spoolman ID" },  // STR_COPY_ID_BTN
  { "Aktive Spulen", "Active spools",
    "Active spools" },  // STR_COPY_ACTIVE_BTN
  { "Archivierte Spulen", "Archived spools",
    "Archived spools" },  // STR_COPY_ARCHIVED_BTN
  { "Neue Spule anlegen?", "Create new spool?",
    "Create new spool?" },  // STR_COPY_CONFIRM_TITLE
  ...
  { "Spule erstellt!", "Spool created!",
    "Spool created!" },  // STR_COPY_OK
  { "Fehler beim Erstellen", "Error creating spool",
    "Error creating spool" },  // STR_COPY_FAIL
  { "Keine Spulen gefunden", "No spools found",
    "No spools found" },  // STR_COPY_NO_SPOOLS
  { "Setup überspringen", "Skip setup",
    "Skip setup" },  // STR_BTN_SKIP_SETUP
  { "Unlink", "Unlink",
    "Unlink" },  // STR_UNLINK_BTN
  { "Spule unlinken?", "Unlink spool?",
    "Unlink spool?" },  // STR_UNLINK_TITLE
  ...
  { "Ortsabfrage bei Entnahme", "Location on removal", "Location on removal" },  // STR_BTN_AUTO_LOC_POPUP
  { "Trocknungserinnerung",     "Drying Reminder",     "Drying Reminder" },  // STR_BTN_DRYING_REMINDER
  { "Trocknungserinnerung",     "Drying Reminder",     "Drying Reminder" },  // STR_DRYING_REMINDER_TITLE

  // Drying Reminder Screen
  { "Aus",      "Off",      "Off" },  // STR_DRY_MODE_OFF
  { "Material", "Material", "Material" },  // STR_DRY_MODE_MATERIAL
  { "Manuell",  "Manual",   "Manual" },  // STR_DRY_MODE_MANUAL
  { "Kein Ampelsignal aktiv.\n\nMaterial: Schwellwerte pro Filamenttyp\n(konfigurierbar im Browser).\n\nManuell: Eigene Grenzwerte in Tagen.",
    ...
    "No alert signal active.\n\nMaterial: Thresholds per filament type\n(configurable in browser).\n\nManual: Custom limits in days." },  // STR_DRY_OFF_DESC
  { "Schwellwerte im Browser editierbar.", "Thresholds editable in browser.",
    "Thresholds editable in browser." },  // STR_DRY_MAT_HINT
  { "Material", "Material",
    "Material" },  // STR_DRY_MAT_HDR_MAT
  { "Gelb (Tage)", "Yellow (days)",
    "Yellow (days)" },  // STR_DRY_MAT_HDR_YELLOW
  { "Rot (Tage)", "Red (days)",
    "Red (days)" },  // STR_DRY_MAT_HDR_RED
  { "Gelb ab", "Yellow from",
    "Yellow from" },  // STR_DRY_MAN_YELLOW_LBL
  { "Rot ab", "Red from",
    "Red from" },  // STR_DRY_MAN_RED_LBL
  { "Tippen zum Bearbeiten", "Tap to edit",
    "Tap to edit" },  // STR_DRY_MAN_EDIT_HINT
  { "Grenzwerte gelten für alle Materialien.", "Limits apply to all materials.",
    "Limits apply to all materials." },  // STR_DRY_MAN_INFO
  { "Tage", "days",
    "days" },  // STR_DRY_DAYS_UNIT
  { "Gelb-Schwellwert", "Yellow threshold",
    "Yellow threshold" },  // STR_DRY_NUMPAD_YELLOW_TITLE
  { "Rot-Schwellwert", "Red threshold",
    "Red threshold" },  // STR_DRY_NUMPAD_RED_TITLE
  { "Effektive Werte (%.1fx Multiplikator eingerechnet)", "Effective values (%.1fx multiplier included)",
    "Effective values (%.1fx multiplier included)" },  // STR_DRY_MAT_EFF_NOTE
  { "Versiegelt", "Sealed",
    "Sealed" },  // STR_DRY_SEALED_HDR
  ...
  { "Filamentverwaltung", "Filament manager", "Filament manager" },  // STR_BACKEND_TITLE
  { "Adresse",            "Address",          "Address" },  // STR_BACKEND_ADDRESS
  { "API-Key",            "API key",          "API key" },  // STR_BACKEND_APIKEY
  { "Device-Token",       "Device token",     "Device token" },  // STR_BACKEND_DEVICE_TOKEN
  { "gesetzt",            "set",              "set" },  // STR_BACKEND_SET
  { "fehlt",              "missing",          "missing" },  // STR_BACKEND_MISSING

  // Web interface. The same server serves the firmware upload and the
  // FilaMan credentials, so the screen title stays neutral.
  { "Weboberfläche", "Web interface", "Web interface" },  // STR_WEB_TITLE
  { "Adresse am Rechner im Browser öffnen und dort API-Key und Gerätecode eintragen. Der Status unten aktualisiert sich von selbst.",
    ...
    "Open this address in a browser on your computer and enter the API key and device code there. The status below updates on its own." },  // STR_WEB_SETUP_HINT
  ...
  { "Adresse am Rechner im Browser öffnen und dort den API-Key eintragen. Der Status unten aktualisiert sich von selbst.",
    ...
    "Open this address in a browser on your computer and enter the API key there. The status below updates on its own." },  // STR_WEB_SETUP_HINT_BB
  { "Im Browser einrichten", "Set up in browser", "Set up in browser" },  // STR_BTN_WEB_SETUP
  { "Fertig",                "Done",              "Done" },  // STR_BTN_FINISH
  { "Weiter",                "Next",              "Next" },  // STR_BTN_NEXT
  { "Welche Filamentverwaltung benutzt du? Das lässt sich später jederzeit im Menü ändern.",
    ...
    "Which filament manager do you use? This can be changed in the menu at any time." },  // STR_SETUP_BACKEND_HINT
  ...
  { "verbunden",         "connected",       "connected" },  // STR_CONNECTED
  { "AN",                "ON",              "ON" },  // STR_ON
  { "AUS",               "OFF",             "OFF" },  // STR_OFF
  { "Im Browser öffnen", "Open in browser", "Open in browser" },  // STR_BTN_OPEN_BROWSER
  ...
  { "Waage - Spule",     "Scale - Spool",        "Scale - Spool" },  // STR_LBL_SCALE_SPOOL_CAP
  { "Gesamt",            "Total",                "Total" },  // STR_LBL_TOTAL_CAP
  { "o. Beutel",         "w/o bag",              "w/o bag" },  // STR_LBL_WO_BAG_CAP
  { "Farbe",             "Hex Color",            "Hex Color" },  // STR_LBL_HEX_COLOR
  { "Produktionsdatum",  "Production date",      "Production date" },  // STR_LBL_PRODUCTION_DATE
  { "Artikelnr.",        "Article no.",          "Article no." },  // STR_LBL_ARTICLE_NO_SHORT
  { "Leergewicht Spule", "Spool weight (empty)", "Spool weight (empty)" },  // STR_LBL_SPOOL_WEIGHT_EMPTY

  // Status bar address selector
  { "Im Statusbalken zeigen", "Show in status bar", "Show in status bar" },  // STR_BTN_IP_STATUSBAR
  { "Gerät",                  "Device",             "Device" },  // STR_IP_BAR_DEVICE
  ...
  { "FilaMan: Spule verknüpfen?", "FilaMan: link spool?", "FilaMan: link spool?" },  // STR_REMOTE_LINK_TITLE
  ...
  { "Verknüpfen",             "Link",                   "Link" },  // STR_REMOTE_LINK_CONFIRM
  { "Details nicht abrufbar", "Details unavailable",    "Details unavailable" },  // STR_REMOTE_LINK_NO_DETAILS
  { "Verknüpfung abgelaufen", "Link request timed out", "Link request timed out" },  // STR_REMOTE_LINK_TIMEOUT

  // Tag versus spool comparison
  { "Tag",      "Tag",      "Tag" },  // STR_REMOTE_LINK_COL_TAG
  { "Spule",    "Spool",    "Spool" },  // STR_REMOTE_LINK_COL_SPOOL
  { "Material", "Material", "Material" },  // STR_REMOTE_LINK_ROW_MATERIAL
  { "Farbe",    "Colour",   "Colour" },  // STR_REMOTE_LINK_ROW_COLOR

  // FilaMan options sub screen
  { "Weitere Optionen",        "More options",       "More options" },  // STR_BTN_MORE_OPTIONS
  { "Mehrere Tags verknüpfen", "Link multiple tags", "Link multiple tags" },  // STR_CU_WRITE
  ...
  { "An: eine gescannte UID kommt an die Liste, statt sie zu ersetzen. "
    ...
    "On: a scanned UID is appended to the list instead of replacing it. Linked spools show up in the link list again so a second tag can join them.\n\nOff: card_uids only ever holds one UID.\n\ncard_uids only, because it is the one extra field that holds a list. Spoolman NFC does several tags natively and needs no switch." },  // STR_CU_WRITE_INFO
  { "UID nicht hinzugefügt",        "UID not added",            "UID not added" },  // STR_CU_NOT_WRITTEN
  { "Tag hängt schon an Spule #%d", "Tag already on spool #%d",
    "Tag already on spool #%d" },  // STR_TAG_ON_OTHER_SPOOL
  ...
  { "UID hinzufügen", "Add UID", "Add UID" },  // STR_BTN_ADD_UID
  ...
  { "Nur dieses Tag",                "Only this tag",                "Only this tag" },  // STR_BTN_UNLINK_ONE
  { "Alle lösen",                    "Unlink all",                   "Unlink all" },  // STR_BTN_UNLINK_ALL
  { "Ohne Nachfrage verknüpfen",     "Link without asking",          "Link without asking" },  // STR_FLM_AUTOLINK
  { "wenn die Spule schon aufliegt", "when the spool is already on",
    "when the spool is already on" },  // STR_FLM_AUTOLINK_SUB
  { " (Filament)",                   " (filament)",                  " (filament)" },  // STR_TARE_FROM_FILAMENT
  { " (Hersteller)",                 " (brand)",                     " (brand)" },  // STR_TARE_FROM_BRAND
  ...
  { "Ohne Tag wiegen",              "Weigh without a tag",           "Weigh without a tag" },  // STR_FLM_TAGLESS
  { "wenn kein Tag aufgelegt wird", "when no tag is presented",
    "when no tag is presented" },  // STR_FLM_TAGLESS_SUB
  { "Spule gewählt - jetzt wiegen", "Spool selected - weigh it now",
    "Spool selected - weigh it now" },  // STR_REMOTE_LINK_WEIGH
  ...
  { "Nie", "Never", "Never" },  // STR_SCREENOFF_NEVER
  ...
  { "Diese Spule",     "This spool",    "This spool" },  // STR_BTN_THIS_SPOOL_FM
  { "Dieses Filament", "This filament", "This filament" },  // STR_BTN_THIS_FILAMENT_FM
  { "Hersteller",      "Manufacturer",  "Manufacturer" },  // STR_BTN_THIS_VENDOR_FM
  { LV_SYMBOL_CLOSE " leer / Archivieren\nRest wird 0",
    LV_SYMBOL_CLOSE " empty / Archive\nremaining set to 0",
  ...
  { "Auto AMS-Zuordnung",           "Auto AMS assign",                "Auto AMS assign" },  // STR_AMS_TITLE
  { "Spule beim Einlegen zuordnen", "assign the spool as it goes in",
    "assign the spool as it goes in" },  // STR_AMS_SUB
  ...
  { "Aus",        "Off", "Off" },  // STR_AMS_MODE_OFF
  { "Nachfragen", "Ask", "Ask" },  // STR_AMS_MODE_ASK
  ...
  { "Automatisch", "Automatic", "Automatic" },  // STR_AMS_MODE_ALWAYS
  ...
  { "Fenster",                               "Window",                            "Window" },  // STR_AMS_WINDOW_LBL
  { "wie lange die Spule vorgemerkt bleibt", "how long the spool stays reserved",
    "how long the spool stays reserved" },  // STR_AMS_WINDOW_HINT
  { "s",                                     "s",                                 "s" },  // STR_AMS_SEC_UNIT
  { "Bei Ablauf", "When it runs out",
    "When it runs out" },  // STR_AMS_TIMER_LBL
  { "wenn niemand antwortet", "when nobody answers",
    "when nobody answers" },  // STR_AMS_TIMER_HINT
  { "Ja",                                    "Yes",                               "Yes" },  // STR_AMS_TIMER_YES
  { "Nein",                                  "No",                                "No" },  // STR_AMS_TIMER_NO
  { "Spule jetzt ins AMS legen?", "Putting the spool into the AMS?",
    "Putting the spool into the AMS?" },  // STR_AMS_POPUP_Q
  { "Zuordnung startet in %d s", "Assignment starts in %d s",
    "Assignment starts in %d s" },  // STR_AMS_POPUP_STARTS_IN
  { "Ohne Zuordnung in %d s", "Without assigning in %d s",
    "Without assigning in %d s" },  // STR_AMS_POPUP_CLOSES_IN
  { "Ja, zuordnen",                          "Yes, assign",                       "Yes, assign" },  // STR_AMS_BTN_YES
  ...
  { "Jedes Projekt legt die Tag-UID in ein anderes Extra-Feld, weil Spoolman "
    ...
    "create.",
    "Every project puts the tag UID in a different extra field, because Spoolman had none for it for a long time. That is changing: Spoolman has grown a tag model of its own.\n\nThis is where you say what the scale writes to. On a server that has the native model it picks that by itself on the first scan; a choice you made yourself is left alone.\n\nEvery source is always read, so nothing goes missing when you switch. On the next link a UID found elsewhere moves into the selected source.\n\nAn extra field has to exist on the server for that - otherwise Spoolman rejects every write with HTTP 400 and the fast search falls back to loading the whole inventory. Spoolman NFC is exempt: there is no field to create." },  // STR_TAG_FIELD_INFO

  { "Spoolman NFC (nativ)",   "Spoolman NFC (native)",    "Spoolman NFC (native)" },  // STR_TF_NATIVE
  { "Vom Server unterstützt", "Supported by the server",  "Supported by the server" },  // STR_TF_NATIVE_SUB
  { "Erst ab Spoolman v0.27", "Spoolman v0.27 and later", "Spoolman v0.27 and later" },  // STR_TF_NATIVE_NA
  { "Spoolman hat inzwischen ein eigenes Tag-Modell, statt einer UID in einem "
    ...
    "still needs it.",
    "Spoolman has grown a tag model of its own, instead of a UID in an extra field. No release carries it yet - this entry only becomes selectable once the server has it.\n\nWhat it does better: a spool can hold several tags with no list squeezed into a text field. A scan is one request that returns the spool with it, rather than a search plus a verification pass. And a tag that already belongs to another spool is reported as such instead of being silently overwritten.\n\nThe extra fields stay selectable regardless: SpoolLink, SpoolSense and FilaMan keep writing their own, and anyone running one of them alongside still needs it." },  // STR_TF_NATIVE_INFO
  { "extra.tag",                 "extra.tag",                "extra.tag" },  // STR_TF_TAG
  { "Diese Waage, OpenSpoolman", "This scale, OpenSpoolman", "This scale, OpenSpoolman" },  // STR_TF_TAG_SUB
  { "Das Feld, das diese Waage seit jeher benutzt, und das auch OpenSpoolman "
    ...
    "The field this scale has always used, and the one OpenSpoolman and spoolnymous write as well.\n\nOne value per spool, no list format. The scale stores the UID the way it reads it, with colons, and the tray_uuid for Bambu tags. OpenSpoolman puts a UUID of its own in there, so the field matches but the contents need not.\n\nThe right choice unless something speaks against it." },  // STR_TF_TAG_INFO
  ...
  { "Das Feld, auf das sich FilaMan, nfc2klipper und SpoolSense geeinigt "
    ...
    "The field FilaMan, nfc2klipper and SpoolSense settled on.\n\nOne value per spool, no list format. It expects plain uppercase hex without separators, so the scale writes 04A1B2C3D4E5F6 rather than 04:A1:B2:C3:D4:E5:F6 - otherwise the other tools will not find the UID.\n\nUseful when one of them works on the same Spoolman database." },  // STR_TF_NFCID_INFO
  ...
  { "Das Feld, das SpoolLink in der Snapmaker-Firmware und Spool Studio "
    ...
    "The field SpoolLink in the Snapmaker firmware and Spool Studio use.\n\nThe only extra field that holds a list: several UIDs, comma separated, plain uppercase hex. On the Snapmaker U1 that is the rule, because a spool carries one tag per flange so it fits either side of the printer.\n\nOf the extra fields only this one allows \"Link multiple tags\". Spoolman NFC can do it too and needs no switch, because several tags are the normal case there rather than a format squeezed into a text field. Given the choice, take Spoolman NFC - this field is the right one when SpoolLink is to run alongside." },  // STR_TF_CARDUIDS_INFO

  { "Trocknungsdatum", "Drying date", "Drying date" },  // STR_EF_LAST_DRIED
  { "Wann die Spule zuletzt getrocknet wurde. Spoolman hat dafür kein eigenes "
    ...
    "When the spool was last dried. Spoolman has no field of its own for it, so the scale writes it to extra.last_dried.\n\nWithout the field the drying line stays empty and the \"Dried\" button has nowhere to save. Nothing else changes." },  // STR_EF_LAST_DRIED_INFO

  { "vorhanden",                   "present",                        "present" },  // STR_EF_PRESENT
  { "fehlt auf dem Server",        "missing on the server",          "missing on the server" },  // STR_EF_MISSING
  { "Feld auf dem Server anlegen", "Create the field on the server",
    "Create the field on the server" },  // STR_EF_CREATE_ROW
  { "Lade Spulen ...",             "Loading spools ...",             "Loading spools ..." },  // STR_LOADING_SPOOLS
  { "%d Spulen, sortiere ...", "%d spools, sorting ...",
    "%d spools, sorting ..." },  // STR_LOADING_FILTER
  ...
  { "Status wählen", "Select status", "Select status" },  // STR_STATUS_TITLE
  { "Neu",           "New",           "New" },  // STR_STATUS_NEW
  { "Geöffnet",      "Opened",        "Opened" },  // STR_STATUS_OPENED
  { "Trocknet",      "Drying",        "Drying" },  // STR_STATUS_DRYING
  { "Aktiv",         "Active",        "Active" },  // STR_STATUS_ACTIVE
  { "Leer",          "Empty",         "Empty" },  // STR_STATUS_EMPTY
  { "Unbekannt",     "Unknown",       "Unknown" },  // STR_STATUS_UNKNOWN

  // Writing a tag
  { "Beschreiben + verknüpfen", "Write + link", "Write + link" },  // STR_REMOTE_LINK_WRITE
  ...
  { "Tag beschreiben?", "Write tag?", "Write tag?" },  // STR_TW_ASK_TITLE
  ...
  { "Beschreiben",               "Write",                      "Write" },  // STR_TW_BTN_WRITE
  { "Nicht jetzt",               "Not now",                    "Not now" },  // STR_TW_BTN_SKIP
  { "Tag beschrieben",           "Tag written",                "Tag written" },  // STR_TW_OK
  { "Kein Tag auf dem Leser",    "No tag on the reader",       "No tag on the reader" },  // STR_TW_ERR_NO_TAG
  { "Dieser Tag ist nur lesbar", "This tag can only be read",  "This tag can only be read" },  // STR_TW_ERR_NOT_NTAG
  { "Spule nicht abrufbar",      "Spool could not be fetched", "Spool could not be fetched" },  // STR_TW_ERR_BACKEND
  ...
  { "Fehlgeschlagen - Tag still halten", "Failed - keep the tag still",
    "Failed - keep the tag still" },  // STR_TW_ERR_WRITE
  { "Tag beim Trigger beschreiben", "Write tag on trigger",
    "Write tag on trigger" },  // STR_FLM_REMOTE_WRITE
  { "Nur wenn nicht gefragt wird", "Only when not asking",
    "Only when not asking" },  // STR_FLM_REMOTE_WRITE_SUB
  ...
  { "Tag nicht beschrieben", "Tag not written", "Tag not written" },  // STR_TW_FAILED
  ...
  { "Tag auch löschen?", "Erase the tag too?", "Erase the tag too?" },  // STR_TW_ERASE_ASK_TITLE
  ...
  { "Löschen",      "Erase",      "Erase" },  // STR_TW_BTN_ERASE
  { "Behalten",     "Keep",       "Keep" },  // STR_TW_BTN_KEEP
  { "Tag gelöscht", "Tag erased", "Tag erased" },  // STR_TW_ERASED
  ...
  { "Tag nicht gelöscht", "Tag not erased", "Tag not erased" },  // STR_TW_ERASE_FAILED
  { "OK",                 "OK",             "OK" },  // STR_BTN_OK
  ...
  { "Referenz: 10 - 20000 g", "Reference: 10 - 20000 g", "Reference: 10 - 20000 g" },  // STR_CAL_RANGE_ERR
  ...
  { "I2C-Bus",          "I2C bus",    "I2C bus" },  // STR_W_R_I2C
  { "Bus neu abfragen", "Rescan bus", "Rescan bus" },  // STR_W_RESCAN
  ...
  { "Was nach dem Verlinken einer Spule mit dem Tag geschieht. Beschrieben "
    ...
    "What happens to the tag once a spool is linked. Writing replaces its contents completely; whatever is on it now is lost.\n\nOff: only the UID is bound to the spool, the tag itself is left alone. Writing is still available on the tag page of the web interface, where what goes on the tag is visible beforehand.\n\nAsk: the scale asks every time.\n\nWrite every time: no question, only the result is reported.\n\nOnly an NTAG with room for the record is written. An NTAG213 with 144 bytes is too small for OpenSpool and FilaMan, NTAG215 and NTAG216 are not. Bambu tags cannot be written at all." },  // STR_TW_OPT_ASK_INFO
  ...
  { "Das Format entscheidet, wer den Tag lesen kann.\n\n"
    ...
    "The format decides who can read the tag.\n\nOpenSpool is an NDEF record carrying material, colour, brand, temperatures and the spool id, which FilaMan and OpenSpool readers understand.\n\nFilaMan is the same record under the protocol name a FilaMan installation expects.\n\nAnycubic ACE writes no record at all but raw pages holding SKU, brand, material, colour, nozzle and bed temperature, diameter, length and weight. The ACE reads those itself." },  // STR_TW_OPT_FMT_INFO
  ...
  { "Tag beschreiben",    "Writing tags",  "Writing tags" },  // STR_W_C_TAGOPTS
  { "Nach dem Verlinken", "After linking", "After linking" },  // STR_W_TAGOPT_ASK
  ...
  { "Gilt für das, was die Waage nach einem Verlinken selbst tut. "
    ...
    "Applies to what the scale does on its own after a link. Writing from this page has its own format selector." },  // STR_W_TAGOPT_NOTE
  { "Speichern",    "Download",   "Download" },  // STR_W_LOG_DOWNLOAD
  { "Kal. löschen", "Reset cal.", "Reset cal." },  // STR_BTN_CAL_RESET_SHORT
  ...
  { "Bei Abweichung fragen", "Ask on a mismatch", "Ask on a mismatch" },  // STR_TW_OPT_MISM
  ...
  { "Traegt der Tag ein anderes Material, eine andere Marke oder eine deutlich "
    ...
    "untouched.",
    "If the tag carries a different material, brand or a clearly different colour than the spool it is bound to, the scale offers to write it again. Only the contents are compared, not the format. Off leaves the tag untouched." },  // STR_TW_OPT_MISM_INFO
  { "Tag weicht ab",   "Tag disagrees", "Tag disagrees" },  // STR_TW_MISM_TITLE
  { "%s",              "%s",            "%s" },  // STR_TW_MISM_HINT
  { "Neu beschreiben", "Write again",   "Write again" },  // STR_TW_BTN_REWRITE
  { "Tag",             "Tag",           "Tag" },  // STR_TW_MISM_TAG
  { "Server",          "Server",        "Server" },  // STR_TW_MISM_SERVER
  ...
  { "Spule %d wird geschrieben...", "Writing spool %d...", "Writing spool %d..." },  // STR_W_TW_WRITING
  { "Tag wird geleert...",          "Erasing the tag...",  "Erasing the tag..." },  // STR_W_TW_ERASING
  { "Spule %d (%s) als %s geschrieben",
    "Wrote spool %d (%s) as %s",
    "Wrote spool %d (%s) as %s" },  // STR_W_TW_WROTE
  { ", verknüpft",      ", linked to the spool", ", linked to the spool" },  // STR_W_TW_LINKED
  { ", verknüpft (%s)", ", linked (%s)",         ", linked (%s)" },  // STR_W_TW_LINKED_NOTE
  { ", aber das Verknüpfen schlug fehl (HTTP %d)",
    ", but linking failed (HTTP %d)",
    ", but linking failed (HTTP %d)" },  // STR_W_TW_LINK_FAIL
  { "Tag geleert", "Tag erased", "Tag erased" },  // STR_W_TW_ERASED
  ...
  { "MIFARE Classic, nur lesbar", "MIFARE Classic, read-only",
    "MIFARE Classic, read-only" },  // STR_W_TAG_KIND_MIFARE
  { "NTAG, beschreibbar",         "NTAG, writable",            "NTAG, writable" },  // STR_W_TAG_KIND_NTAG
  { ", %u Byte",                  ", %u bytes",                ", %u bytes" },  // STR_W_TAG_KIND_BYTES
  { "Gebunden über: %s",          "Bound through: %s",         "Bound through: %s" },  // STR_UNLINK_SOURCES
  { "Aus",                        "Off",                       "Off" },  // STR_TW_MODE_OFF
  { "Fragen",                     "Ask",                       "Ask" },  // STR_TW_MODE_ASK
  { "Immer schreiben",            "Write every time",          "Write every time" },  // STR_TW_MODE_ALWAYS

  // ---- Hardware self diagnosis -----------------------------------------
  { "  -  antippen", "  -  tap for help", "  -  tap for help" },  // STR_DIAG_TAP
  { "Später",        "Later",             "Later" },  // STR_DIAG_BTN_LATER
  { "Erneut prüfen", "Check again",       "Check again" },  // STR_DIAG_BTN_RECHECK

  { "Kein Modul am I2C-Bus", "Nothing on the I2C bus", "Nothing on the I2C bus" },  // STR_DIAG_BUS_EMPTY_BANNER
  { "Kein Modul am I2C-Bus", "Nothing on the I2C bus", "Nothing on the I2C bus" },  // STR_DIAG_BUS_EMPTY_TITLE
  { "Weder der NFC-Reader noch der Waagen-ADC antworten.\n\n"
    ...
    "pin 4 (SCL, green).",
    "Neither the NFC reader nor the scale ADC answers.\n\nThe 7 pin cable has to sit flush to the left in the 8 pin I/O socket. One pin off and both modules are unpowered.\n\nCheck pin 1 (5V, red), pin 2 (GND, black), pin 3 (SDA, yellow) and pin 4 (SCL, green)." },  // STR_DIAG_BUS_EMPTY_TEXT

  { "Waagen-ADC fehlt (NAU7802)", "Scale ADC missing (NAU7802)",
    "Scale ADC missing (NAU7802)" },  // STR_DIAG_NAU_MISSING_BANNER
  { "Waagen-ADC fehlt",           "Scale ADC missing",           "Scale ADC missing" },  // STR_DIAG_NAU_MISSING_TITLE
  { "Die NAU7802 antwortet nicht auf 0x2A. Der NFC-Reader schon, SDA und SCL "
    ...
    "The NAU7802 does not answer on 0x2A. The NFC reader does, so SDA and SCL are basically fine.\n\nCheck VIN, GND, SDA and SCL on the NAU7802.\n\nOn third party STEMMA QT cables the pin order often does not match the WT32 cable.\n\nIf this device was deliberately built without a scale, switch it off under Settings > Scale and this finding goes away." },  // STR_DIAG_NAU_MISSING_TEXT

  { "NFC-Reader fehlt (PN532)", "NFC reader missing (PN532)",
    "NFC reader missing (PN532)" },  // STR_DIAG_PN532_MISSING_BANNER
  { "NFC-Reader fehlt",         "NFC reader missing",         "NFC reader missing" },  // STR_DIAG_PN532_MISSING_TITLE
  { "Der PN532 antwortet nicht auf 0x24. Der Waagen-ADC schon, SDA und SCL "
    ...
    "carries 3.3V.",
    "The PN532 does not answer on 0x24. The scale ADC does, so SDA and SCL are basically fine.\n\nCheck the two DIP switches on the module first: I2C needs SW1 = ON and SW2 = OFF. Set to HSU or SPI the chip does not answer on the I2C bus at all - which is exactly what is happening here.\n\nOtherwise the PN532 needs 5V from pin 1 of the I/O cable. Do not daisy chain it through the NAU7802 STEMMA QT passthrough - that one only carries 3.3V." },  // STR_DIAG_PN532_MISSING_TEXT

  { "NFC-Reader antwortet nicht", "NFC reader does not answer",
    "NFC reader does not answer" },  // STR_DIAG_PN532_MUTE_BANNER
  { "NFC-Reader meldet sich nicht", "NFC reader stays silent",
    "NFC reader stays silent" },  // STR_DIAG_PN532_MUTE_TITLE
  { "Der PN532 bestätigt 0x24, beantwortet aber keinen Befehl. Er steht damit "
    ...
    "The PN532 acknowledges 0x24 but answers no command. That means it is set to I2C - it would not answer at all otherwise - and SDA and SCL are right too.\n\nCheck the two DIP switches first: I2C needs SW1 = ON and SW2 = OFF. A switch resting between positions is the most common cause.\n\nThen check the 5V on pin 1. Too little supply lets the chip announce itself on the bus without being able to work.\n\nThere is no reset to pull here: the orange RST wire sits on an output of the module rather than its reset input. Unplugging and replugging is the only hard reset there is." },  // STR_DIAG_PN532_MUTE_TEXT

  { "Waage nicht kalibriert", "Scale not calibrated", "Scale not calibrated" },  // STR_DIAG_UNCAL_BANNER
  { "Waage nicht kalibriert", "Scale not calibrated", "Scale not calibrated" },  // STR_DIAG_UNCAL_TITLE
  { "Der angezeigte Wert ist der Rohwert des ADC, nicht Gramm. Deshalb steht "
    ...
    "The value on screen is the raw ADC reading, not grams. That is why it is a six digit number that jumps by hundreds on its own.\n\nThis is neither a defect nor a wiring mistake. The scale simply does not know yet how many counts make a gram.\n\nPlace a known weight on it and calibrate." },  // STR_DIAG_UNCAL_TEXT

  { "Wägezelle verpolt (A+/A-)", "Load cell reversed (A+/A-)",
    "Load cell reversed (A+/A-)" },  // STR_DIAG_INVERTED_BANNER
  { "Wägezelle verpolt",         "Load cell reversed",         "Load cell reversed" },  // STR_DIAG_INVERTED_TITLE
  { "Die Waage liest bei leerer Plattform stark negativ und hat seit dem Start "
    ...
    "The scale reads far below zero with an empty platform and has never seen a positive weight since it started. Loading it makes the number go down instead of up.\n\nSwap the two signal wires on the NAU7802: A+ (white) and A- (green).\n\nThen tare and calibrate again." },  // STR_DIAG_INVERTED_TEXT

  { "Wägezelle unruhig", "Load cell unstable", "Load cell unstable" },  // STR_DIAG_NOISY_BANNER
  { "Wägezelle unruhig", "Load cell unstable", "Load cell unstable" },  // STR_DIAG_NOISY_TITLE
  { "Der Messwert schwankt dauerhaft um mehr als %d g, obwohl auf der "
    ...
    "The reading keeps swinging by more than %d g although nothing on the platform is moving.\n\nThat is typical for a loose wire on the NAU7802. Check E+ (red), E- (black), A+ (white) and A- (green) for cold solder joints.\n\nAlso check whether a cable is pressing against the weighing platform." },  // STR_DIAG_NOISY_TEXT

  { "So kalibrierst du", "How to calibrate", "How to calibrate" },  // STR_CAL_HELP_TITLE
  { "1. Plattform leer räumen und TARE drücken. Die Anzeige muss auf 0 gehen.\n\n"
    ...
    "afterwards.",
    "1. Clear the platform and press TARE. The reading has to go to 0.\n\n2. Place a weight you know exactly. Around 1000 g is ideal - a full spool checked on a kitchen scale is plenty.\n\n3. Type that weight in grams and press Calculate.\n\nThe more precise the reference weight, the more accurate the scale is afterwards." },  // STR_CAL_HELP_TEXT

  { "Diagnose",    "Diagnosis",     "Diagnosis" },  // STR_W_R_DIAG
  { "ohne Befund", "nothing found", "nothing found" },  // STR_W_S_DIAG_OK

  // ---- PN532 reset line, the optional hardware modification ----
  { "Hardware-Umbau möglich", "A hardware change is available",
    "A hardware change is available" },  // STR_NFCRST_HINT_TITLE
  { "Der NFC-Leser dieser Waage musste schon einmal neu gestartet werden.\n\n"
    ...
    "The NFC reader on this scale has had to be restarted at least once.\n\nThere is an optional change against it: the orange RST wire belongs on RSTPDN. The scale can then genuinely reset the reader.\n\nGuide in the docs under Wiring. Check afterwards under System > Check NFC reset. Nothing breaks if you leave it." },  // STR_NFCRST_HINT_TEXT
  { "Später",              "Later",             "Later" },  // STR_NFCRST_LATER
  { "Nicht mehr anzeigen", "Do not show again", "Do not show again" },  // STR_NFCRST_NEVER

  { "NFC-Reset prüfen",       "Check NFC reset",       "Check NFC reset" },  // STR_NFCRST_ROW
  { "Nach dem Umlöten",       "After the rewiring",    "After the rewiring" },  // STR_NFCRST_ROW_SUB
  { "Leitung geprüft, aktiv", "Line verified, in use", "Line verified, in use" },  // STR_NFCRST_ROW_DONE
  { "Reset-Leitung sitzt",    "Reset line is there",   "Reset line is there" },  // STR_NFCRST_OK_TITLE
  { "Der Leser hat auf die Leitung reagiert. Ab dem nächsten Start benutzt "
    ...
    "hardware reset.",
    "The reader responded to the line. From the next start the scale uses the hardware reset." },  // STR_NFCRST_OK_TEXT
  { "Keine Wirkung", "No effect", "No effect" },  // STR_NFCRST_FAIL_TITLE
  { "Der Leser hat nichts gemerkt. Der orange Draht liegt noch auf dem alten "
    ...
    "The reader did not notice. The orange wire is still on the old pad, or the joint is not making contact.\n\nNothing changes, the scale carries on as before." },  // STR_NFCRST_FAIL_TEXT

  // ── Hardware UID into extra.rfid_tag ──
  { "Chip-UID mitschreiben",  "Also write the chip UID", "Also write the chip UID" },  // STR_HW_UID_WRITE
  { "Zusätzlich in rfid_tag", "Into rfid_tag as well",   "Into rfid_tag as well" },  // STR_HW_UID_WRITE_SUB
  { "An: die Hardware-UID des Chips, der gerade auf dem Leser liegt, kommt "
    ...
    "On: the hardware UID of the chip currently on the reader goes into the rfid_tag extra field as well, as a comma separated list. The binding itself stays untouched in the field selected above.\n\nHappy Hare on a Voron reads rfid_tag and nothing else, and the readers at its gates only ever see the chip's hardware UID, never the tray_uuid of a Bambu spool. Without this field the printer cannot find the spool the scale recognises perfectly well.\n\nA Bambu spool carries two chips and therefore two UIDs. The list grows on its own: put each side on the reader once and the spool answers at both gates.\n\nThe scale writes this into every spool it recognises, not only when a link is made. Once the UID is in there, no request goes out again. Happy Hare creates the field itself." },  // STR_HW_UID_WRITE_INFO

  // ── A link that could not use the selected source ──
  { "Tag-Quelle nicht verfügbar", "Tag source unavailable", "Tag source unavailable" },  // STR_TF_NOREL_TITLE
  { "Dieser Spoolman hat noch keine eigene Tag-Relation - die gibt es erst ab "
    ...
    "This Spoolman has no tag relation of its own yet - that arrives in v0.27. The selected source is native tags all the same.\n\nThe tag went into the extra field tag instead, which every Spoolman has. The spool is found by it, just not by the fastest route.\n\nBetter for good: set the tag source to card_uids under Settings. That field also holds several UIDs per spool, so a second tag fits too. Once the server is on v0.27 the scale moves the binding into the relation by itself, on the next link." },  // STR_TF_NOREL_TEXT

  // ── The tag on the other flange ──
  { "Zweites Tag abfragen", "Ask for a second tag", "Ask for a second tag" },  // STR_TAG2_ASK
  { "Nach dem Verknüpfen",  "Right after a link",   "Right after a link" },  // STR_TAG2_ASK_SUB
  { "An: nach jedem erfolgreichen Verknüpfen fragt die Waage nach einem "
    ...
    "tag writing setting.",
    "On: after every successful link the scale asks for a second tag. Turn the spool over, put the tag on the reader, done - it goes to the same spool as the first one.\n\nWhat was asked for was a second reader, one per side of the case. The hardware has one, so here a flow does what a part would have done.\n\nOn a Bambu spool both chips carry the same tray uuid, so the second chip uid would turn up eventually anyway. The question only says when that moment is. Two NTAGs share nothing at all, and without it the spool has to be looked up by hand a second time.\n\nThe row only appears where the selected source can hold more than one tag. Whether the second tag is written as well is still decided by the tag writing setting." },  // STR_TAG2_ASK_INFO
  ...
  { "Schließt in %d s",      "Closes in %d s",    "Closes in %d s" },  // STR_TAG2_CLOSES_IN
  { "Fertig",                "Done",              "Done" },  // STR_TAG2_BTN_DONE
  { "Zweites Tag verknüpft", "Second tag linked", "Second tag linked" },  // STR_TAG2_LINKED

  // ── A device built without a load cell ──
  { "Keine Waage angeschlossen", "No scale connected", "No scale connected" },  // STR_NO_SCALE
  { "Waage vorhanden",           "Scale fitted",       "Scale fitted" },  // STR_SCALE_FITTED
  { "An: das Gerät hat eine Wiegezelle und verhält sich wie bisher.\n\n"
    ...
    "On: the device has a load cell and behaves exactly as before.\n\nOff: the whole weighing side disappears. The NAU7802 is not even looked for at startup, the main screen carries a note instead of the weights and nothing where TARE used to be, the \"Update weight\" button becomes the location button, and calibration and bag weight leave this menu.\n\nMeant for a device built from display and reader alone: hold a tag against it, see the spool, give it a location and a printer. Without this switch such a device reports a fault it does not have, for good.\n\nChanging it needs a restart." },  // STR_SCALE_FITTED_INFO
  { "Ohne Waage | Mehr", "No scale | More", "No scale | More" },  // STR_TILE_SCALE_SUB_OFF
  { "Waage vorhanden",   "Scale fitted",    "Scale fitted" },  // STR_W_SCALE_FITTED
  ...
  { "abgeschaltet", "switched off", "switched off" },  // STR_W_S_SCALE_OFF

  { "Passwort", "Password", "Password" },  // STR_WEB_PASS
  { "Gesetzt - der Browser fragt danach",
    "Set - the browser asks for it",
    "Set - the browser asks for it" },  // STR_WEB_PASS_SET
  { "Nicht gesetzt", "Not set", "Not set" },  // STR_WEB_PASS_UNSET
  { "Schützt die Bereiche Einstellungen und Gerät im Browser: Backend, "
    ...
    "Protects the Settings and Device sections in the browser: backend, settings, tags, logs and firmware. Without a password any device on the network can use those sections once they are switched on - firmware upload included.\n\n4 to 8 digits. The browser asks for it, the user name does not matter. Save empty to remove the password." },  // STR_WEB_PASS_INFO
  { "Web-Passwort", "Web password", "Web password" },  // STR_WEB_PASS_TITLE
  ...
  { "Passwort",      "Password", "Password" },  // STR_W_R_PASSWORD
  { "gesetzt",       "set",      "set" },  // STR_W_S_SET
  { "nicht gesetzt", "not set",  "not set" },  // STR_W_S_NOTSET
  { "Ohne Passwort kann jedes Gerät im Netz die eingeschalteten Bereiche nutzen, "
    ...
    "Without a password any device on the network can use the sections that are on, firmware upload included. Set one on the device under" },  // STR_W_PASS_NOTE
  ...
  { "Diese Adresse gehört nicht zur Waage. Bitte über die IP-Adresse oder den "
    ...
    "its device name.",
    "This address does not belong to the scale. Open it by IP address or by its device name." },  // STR_W_BAD_HOST
  ...
  { "%d Spulen", "%d spools", "%d spools" },  // STR_SPOOLS_COUNT
  ...
  { "Zweites Tag nicht verknüpft", "Second tag not linked", "Second tag not linked" },  // STR_TAG2_FAILED
  { "Spule #%d verliert das Tag.",
    "Spool #%d loses the tag.",
    "Spool #%d loses the tag." },  // STR_TAGMOVE_HINT
  { "Umhängen",                "Move",           "Move" },  // STR_TAGMOVE_BTN
  { "Umhängen fehlgeschlagen", "Move failed",    "Move failed" },  // STR_TAGMOVE_FAILED
  { "Hängt an:",               "On spool:",      "On spool:" },  // STR_TAGMOVE_FROM
  { "Umhängen zu:",            "Move to:",       "Move to:" },  // STR_TAGMOVE_TO
  { "%d Min",                  "%d min",         "%d min" },  // STR_MINUTES_FMT
  { "%d T.",                   "%d d",           "%d d" },  // STR_DAYS_ABBR_FMT
  { "%.0f g neu",              "%.0f g new",     "%.0f g new" },  // STR_NEW_SPOOL_WEIGHT_FMT
  { "Diff",                    "Diff",           "Diff" },  // STR_LBL_DIFF_CAP
  { "Datei wählen",            "Choose file",    "Choose file" },  // STR_W_FW_CHOOSE
  { "Keine Datei gewählt",     "No file chosen", "No file chosen" },  // STR_W_FW_NOFILE
  { "Wartung (Firmware, Logs, Tags)",
    "Maintenance (firmware, logs, tags)",
    "Maintenance (firmware, logs, tags)" },  // STR_W_R_MAINT_GATE
  { "AMS-Ansicht", "AMS view", "AMS view" },  // STR_AMS_BTN_VIEW
  { "%s -> Fenster für die Zuordnung öffnen?",
    "%s -> open the assignment window?",
    "%s -> open the assignment window?" },  // STR_AMSV_WINDOW_HEAD
  { "Fenster öffnen", "Open window", "Open window" },  // STR_AMSV_BTN_WINDOW
  ...
  { "WLAN ändern",                  "Change WiFi",              "Change WiFi" },  // STR_BTN_WIFI_CHANGE
  { "Per Handy einrichten",         "Set up by phone",          "Set up by phone" },  // STR_BTN_WIFI_PORTAL
  { "WLAN per Handy einrichten",    "Set up WiFi by phone",     "Set up WiFi by phone" },  // STR_PORTAL_TITLE
  { "1. WLAN der Waage beitreten",  "1. Join the scale's WiFi", "1. Join the scale's WiFi" },  // STR_PORTAL_STEP_JOIN
  { "2. Seite öffnen",              "2. Open the page",         "2. Open the page" },  // STR_PORTAL_STEP_OPEN
  { "WLAN: %s",                     "WiFi: %s",                 "WiFi: %s" },  // STR_PORTAL_NET_FMT
  { "Passwort: %s",                 "Password: %s",             "Password: %s" },  // STR_PORTAL_PASS_FMT
  { "Öffnet sich meist von selbst", "Usually opens by itself",
    "Usually opens by itself" },  // STR_PORTAL_OPENS_ITSELF
  ...
  { "Warte auf Eingabe am Handy...", "Waiting for the phone...", "Waiting for the phone..." },  // STR_PORTAL_WAITING
  ...
  { "Netzwerk",     "Network",       "Network" },  // STR_PORTAL_PAGE_NETWORK
  { "Bitte wählen", "Please choose", "Please choose" },  // STR_PORTAL_PAGE_CHOOSE
  { "Oder Namen eingeben (verstecktes Netz)",
    "Or type its name (hidden network)",
    "Or type its name (hidden network)" },  // STR_PORTAL_PAGE_OTHER
  { "Passwort",  "Password", "Password" },  // STR_PORTAL_PAGE_PASS
  { "Verbinden", "Connect",  "Connect" },  // STR_PORTAL_PAGE_SUBMIT
  ...
  { "API-Key fehlt noch", "API key still missing", "API key still missing" },  // STR_BB_KEY_MISSING
  { "API-Key abgelehnt",  "API key rejected",      "API key rejected" },  // STR_BB_KEY_REJECTED

  // AMS view: info mode and the detail card
  { "Info", "Info", "Info" },  // STR_AMSV_INFO
  ...
  { "%s - Fach %d", "%s - bay %d", "%s - bay %d" },  // STR_AMSD_BAY
  { "Restmenge",    "Remaining",   "Remaining" },  // STR_AMSD_REMAINING
  { "%s von %s",    "%s of %s",    "%s of %s" },  // STR_AMSD_OF
  ...
  { "Details werden geladen ...", "Loading details ...", "Loading details ..." },  // STR_AMSD_LOADING
  { "Details nicht abrufbar",     "Details unavailable", "Details unavailable" },  // STR_AMSD_FAIL
  { "Ersatz %s",                  "Backup %s",           "Backup %s" },  // STR_AMSD_BACKUP
  { "Trocknung von heute für\ndiese Spule speichern?",
    "Record today's drying for\nthis spool?",
    "Record today's drying for\nthis spool?" },  // STR_AMSD_DRIED_Q
  { "Wird gespeichert ...",     "Saving ...",    "Saving ..." },  // STR_AMSD_SAVING
  { "Speichern fehlgeschlagen", "Saving failed", "Saving failed" },  // STR_AMSD_WRITE_FAIL

  // The caption the main screen and More Info used to spell out as a literal.
  { "Material", "Material", "Material" },  // STR_LBL_MATERIAL
};
