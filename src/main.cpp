...
bool spoolman_fail_is_setup  = false;                // for spoolman fail screen
...
bool skip_setup_pending = false;         // deferred from skip button callback
bool cal_reminder_pending = false;                   // deferred showCalReminderScreen from callback
...
bool lang_selected_no_reboot = false;                // EN selected on welcome screen, go to firstboot without reboot
// ============================================================
//  GLOBAL OBJECTS
// ============================================================
bool nfc_ok = false;
...
bool tag_present = false;                      // tag currently on reader?
...
lv_obj_t *lbl_burger_badge   = nullptr; // yellow dot on burger button (mainscreen)
...
lv_obj_t *lbl_weight_main_lbl = nullptr;         // Label des Zone-5 "Gewicht updaten" Buttons
...
int nfc_absent_count = 0;   // consecutive "not found" reads before tag_present = false
...
// Tag display refresh lives in ui/main_screen.cpp.
