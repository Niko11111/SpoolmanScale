...
The firmware is stable at **Beta\_0.4.125**. Public beta is planned as version **0.5.0**.
...
| USB-C Panel Mount 90° Extension | 90° left/right, 30 cm – tested and working with full USB-C PD and data support | [AliExpress](https://a.aliexpress.com/_EjQ6sma) |
